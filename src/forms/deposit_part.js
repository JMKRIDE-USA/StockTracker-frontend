...
export function DepositPartForm() {
  ...
  const [mutate, { error }] = useMutation(({ to_submit }) => fetch(
    server_url + api_path + "inventory/actions/deposit",
    {
      method: "PUT",
    ...
    <div className="Form">
      <div className="FormBox">
        <div className="FormRow">
          <p className="RowFormTitle">Deposit Part: </p>
        ...
        <form id="deposit_part" className="RowFormContent" onSubmit={handleSubmit}>
          <div className="FormRow">
            <label>
              Filter Parts:
              { makeTypeSelector(
